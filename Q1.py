...
plt.grid(True)
plt.tight_layout()
plt.savefig("output/figure1_degree_distribution.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figure2_giant_component.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figure3_largest_clique.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("output/figure4_degree_vs_centrality.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("output/figure5_degree_vs_betweenness.png")
plt.close()
...
plt.tight_layout()
plt.savefig("output/figure6_ego_network.png")
plt.close()
